      ...
      <div class="container">
          <div class="row">
              <div class="col">
                  ...
                  <hr>
                  <a href="admin-orders.php" class="btn btn-dark btn-sm mt-2"> Užsakymai </a>
                  <a href="admin-orders-complete.php" class="btn btn-dark btn-sm mt-2"> Atlikti užsakymai </a>
                  <a href="admin-users.php" class="btn btn-dark btn-sm mt-2"> Vartotojai </a>
                  <a href="admin-post.php" class="btn btn-dark btn-sm mt-2"> Įrašai </a>
                  </hr>
              </div>
              <div class="col">
